...
class ProPomodoro(ctk.CTk):
    def __init__(self):
        ...
        self.title("MASA FocusTimer Suite")
    ...
    def setup_timer_ui(self):
        ...
        self.btn_reset = ctk.CTkButton(
            self.tab_timer, text="Reset", fg_color="transparent", border_width=2, command=self.reset_timer
        )
    ...
    def setup_settings_ui(self):
        ...
        self.work_value_label = ctk.CTkLabel(
            self.tab_settings, text="25 min", font=("Roboto", 14, "bold"), text_color="#2ecc71"
        )
        self.work_value_label.pack()

        self.work_slider = ctk.CTkSlider(
            self.tab_settings, from_=1, to=60, command=lambda v: self.update_times()
        )
        ...
        self.break_value_label = ctk.CTkLabel(
            self.tab_settings, text="5 min", font=("Roboto", 14, "bold"), text_color="#3498db"
        )
        self.break_value_label.pack()

        self.break_slider = ctk.CTkSlider(
            self.tab_settings, from_=1, to=30, command=lambda v: self.update_times()
        )
